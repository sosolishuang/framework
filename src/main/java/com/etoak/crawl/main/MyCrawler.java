...
public class MyCrawler {
    ...
    public void crawling(String[] seeds) {
        ...
        LinkFilter filter = new LinkFilter() {
            public boolean accept(String url) {
                if (url.startsWith("http://pic.netbian.com/"))
                    return true;
                else
                    return false;
            }
        ...
        while (!Links.unVisitedUrlQueueIsEmpty()  && Links.getVisitedUrlNum() <= 1000) {
            ...
            if(!es.isEmpty()){
                System.out.println("=========================下面将打印所有校花图片： =========================");
    ...
    public static void main(String[] args) {
        ...
        //http://pic.netbian.com/uploads/allimg/180607
        crawler.crawling(new String[]{"http://pic.netbian.com/index_2.html"});
//        crawler.crawling(new String[]{"http://www.521609.com/daxuexiaohua/"});
    }
}
